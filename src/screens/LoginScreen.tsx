...
const LoginScreen = () => {
  ...
  const [loginMode, setLoginMode] = useState<"student" | "createParent">(
    "student"
  ); // Mặc định là học sinh
  const [parentStep, setParentStep] = useState<"email" | "otp" | "password">(
    "email"
  ); // Bước cho createParent
  ...
  useEffect(() => {
    ...
    if (auth.user) {
      if (loginMode === "student" && rememberMe)
  ...
  const handleVerifyOTP = () => {
    ...
    setErrorMessage("");
    const payload = new VerifyOTPRequestDTO({
      Email: parentEmail,
      OTP: otpCode,
    });
          ...
          >
            ...
            <View style={{ flexDirection: "row", marginBottom: 16 }}>
              ...
              >
                <Text
                  style={{
                    ...
                    color: loginMode === "student" ? "#3b82f6" : "#6b7280",
                  }}
                >
                  Đăng nhập
                </Text>
              ...
              >
                <Text
                  style={{
                    fontWeight: loginMode === "createParent" ? "600" : "400",
                    color: loginMode === "createParent" ? "#3b82f6" : "#6b7280",
                    fontSize: 14,
                    flexWrap: "nowrap",
                    textAlign: "center",
                  }}
            ...
            {loginMode === "student" && (
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() =>
                    Alert.alert("Quên mật khẩu", "Liên hệ hỗ trợ để đặt lại.")
                  }
                >
                  <Text
                    style={{
